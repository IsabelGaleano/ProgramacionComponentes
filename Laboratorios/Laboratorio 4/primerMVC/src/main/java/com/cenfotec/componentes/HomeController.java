...
import com.cenfotec.componentes.beans.BeanTarea;
...
public class HomeController {
	...
	public String tarea(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
		...
		tareaBean.setNumero(5);

		model.addAttribute("serverTime", formattedDate );
		model.addAttribute("tarea", tareaBean);
